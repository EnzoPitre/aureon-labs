      ...
      <div className="container-main">
        ...
        >
          ...
          <div>
            ...
            <p style={{ color: "#7a7a7a", fontSize: "14px", lineHeight: 1.75, marginBottom: "1.5rem" }}>
            ...
            >
              {submitted ? (
                <div style={{ textAlign: "center", padding: "2rem 0" }}>
                  ...
                  <p style={{ color: "#7a7a7a", fontSize: "13px", lineHeight: 1.7 }}>
                ...
                <>
                  ...
                  <p style={{ marginTop: "1rem", fontSize: "11px", color: "#3a3a3a", textAlign: "center" }}>
