      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1rem", marginBottom: "2.5rem" }}>
            <p style={{ color: "#5c564e", fontSize: "14px", lineHeight: 1.8, margin: 0 }}>
          ...
          >
            ...
            <div>
              ...
              <div style={{ fontSize: "11px", color: "#83796b" }}>
        ...
        >
            ...
            {benefits.map((item, i) => (
              <div
                ...
                style={{
                  ...
                  gap: "1.5rem",
                  padding: "1.75rem 0",
                  borderBottom: i < benefits.length - 1 ? "1px solid #d8cfc0" : "none",
                  alignItems: "start",
                }}
              >
                <span
                ...
                <div>
                  ...
                  <p style={{ color: "#83796b", fontSize: "13px", lineHeight: 1.7, margin: 0 }}>
                    {item.desc}
                  </p>
                </div>
              </div>
          ...
          >
            <div>
              <div style={{ fontSize: "11px", color: "#83796b", marginBottom: "0.2rem" }}>
                À partir de
              </div>
              <div style={{ fontSize: "22px", fontWeight: 700, color: "#282828", letterSpacing: "-0.02em" }}>
                21,99€
              </div>
            </div>
