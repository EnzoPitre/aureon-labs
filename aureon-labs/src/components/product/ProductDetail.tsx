    ...
    <span style={{ display: "inline-flex", gap: "2px" }}>
      {Array.from({ length: 5 }, (_, i) => (
        <Star
          ...
          style={{ color: i < Math.floor(rating) ? "#f59e0b" : "#c9bfae" }}
        />
      ))}
    </span>
  );
  ...
  return (
    <div style={{ paddingTop: "88px" }}>
      ...
      <div
        ...
        style={{ paddingTop: "1.25rem", paddingBottom: "1.25rem", borderBottom: "1px solid #d8cfc0" }}
      >
        <nav style={{ display: "flex", gap: "0.5rem", alignItems: "center", fontSize: "11px", color: "#a39a8a", letterSpacing: "0.06em" }}>
          <Link
            href="/"
            style={{ color: "#a39a8a", textDecoration: "none", transition: "color 0.2s" }}
          ...
          <span>/</span>
          <span style={{ color: "#5c564e" }}>{product.name.toUpperCase()}</span>
        </nav>
      </div>
        ...
        >
                ...
                {product.images.map((img, i) => (
                  <button
                    ...
                    style={{
                      ...
                      height: "64px",
                      overflow: "hidden",
                      border: `1px solid ${activeImage === i ? "#282828" : "#d8cfc0"}`,
                      cursor: "pointer",
                      padding: 0,
                      background: "#f1ede7",
          ...
          <div style={{ position: "sticky", top: "72px" }}>
            {product.badge && (
              <div
                ...
                style={{
                  ...
                  color: product.badge === "NOUVEAU" ? "#282828" : "#282828",
                  border: `1px solid ${product.badge === "NOUVEAU" ? "rgba(40,40,40,0.3)" : "rgba(40,40,40,0.3)"}`,
            ...
            >
              ...
              <span style={{ fontSize: "12px", color: "#83796b", letterSpacing: "0.02em" }}>
            ...
            <p style={{ color: "#83796b", lineHeight: 1.75, marginBottom: "2rem", fontSize: "14px" }}>
              {product.description}
            </p>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "1.25rem", marginBottom: "1.25rem" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", border: "1px solid #d8cfc0" }}>
                <button
                  onClick={() => setQuantity(Math.max(1, quantity - 1))}
                  style={{
                    background: "none", border: "none", cursor: "pointer", color: "#83796b",
                ...
                <span
                  style={{
                    fontSize: "13px", color: "#282828", minWidth: "36px", textAlign: "center",
                    borderLeft: "1px solid #d8cfc0", borderRight: "1px solid #d8cfc0",
            ...
            <div style={{ display: "flex", gap: "0.625rem", marginBottom: "2.5rem" }}>
              ...
              <button
                ...
                style={{
                  background: wished ? "rgba(40,40,40,0.08)" : "transparent",
                  border: `1px solid ${wished ? "#282828" : "#c9bfae"}`,
                  cursor: "pointer",
                ...
                onMouseLeave={(e) => {
                  if (!wished) {
                    ...
                    e.currentTarget.style.color = "#a39a8a";
                  }
                }}
              >
                <Heart size={15} fill={wished ? "#282828" : "none"} strokeWidth={1.5} />
              </button>
            </div>

            {/* Specs — flat table */}
            <div style={{ borderTop: "1px solid #d8cfc0" }}>
              ...
              {specs.map((spec, i) => (
                <div
                  ...
                  style={{
                    ...
                    alignItems: "center",
                    padding: "0.5rem 0",
                    borderBottom: i < specs.length - 1 ? "1px solid #e3dccd" : "none",
                  }}
                >
                  <span
                    style={{
                      fontSize: "11px", color: "#a39a8a", display: "flex",
                  ...
                  <span style={{ fontSize: "12px", color: "#5c564e" }}>{spec.value}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      {/* Story */}
      <div style={{ borderTop: "1px solid #d8cfc0", padding: "5rem 0", background: "#ece6dc" }}>
        <div className="container-main" style={{ maxWidth: "760px" }}>
          <div className="label" style={{ marginBottom: "1rem", color: "#282828" }}>
          ...
          >
            L&apos;histoire du{" "}
            <em style={{ fontStyle: "italic", color: "#83796b" }}>{product.name}</em>
          </h2>
          <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
            {product.story.split("\n\n").map((para, i) => (
              <p key={i} style={{ color: "#83796b", lineHeight: 1.85, fontSize: "15px" }}>
                {para.trim()}
              </p>
            ))}
          </div>
      ...
      {/* Reviews */}
      <div style={{ padding: "5rem 0", borderTop: "1px solid #d8cfc0" }}>
        <div className="container-main">
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
              ...
              <span style={{ fontSize: "1.5rem", fontWeight: 300, letterSpacing: "-0.03em", color: "#282828" }}>
                {product.rating}
              </span>
              <span style={{ fontSize: "12px", color: "#a39a8a" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", maxWidth: "720px", marginBottom: "4rem" }}>
            {mockReviews.map((review, i) => (
              <div
                ...
                style={{
                  padding: "1.75rem 0",
                  borderBottom: i < mockReviews.length - 1 ? "1px solid #d8cfc0" : "none",
                }}
              >
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "0.75rem" }}>
                  <div>
                    <Stars rating={review.rating} size={12} />
                    <p style={{ fontSize: "13px", fontWeight: 500, color: "#282828", marginTop: "0.4rem" }}>
                      {review.userName}
                    </p>
                  </div>
                  <span style={{ fontSize: "11px", color: "#a39a8a", letterSpacing: "0.04em" }}>
                    {new Date(review.createdAt).toLocaleDateString("fr-FR")}
                  </span>
                </div>
                <p style={{ fontSize: "13px", fontWeight: 500, color: "#5c564e", marginBottom: "0.5rem" }}>
                  {review.title}
                </p>
                <p style={{ color: "#a39a8a", fontSize: "13px", lineHeight: 1.7, margin: 0 }}>
                  {review.comment}
                </p>
                <div style={{ marginTop: "1rem" }}>
                  <button
                    ...
                    onMouseEnter={(e) => { e.currentTarget.style.borderColor = "#a39a8a"; e.currentTarget.style.color = "#5c564e"; }}
                    onMouseLeave={(e) => { e.currentTarget.style.borderColor = "#d8cfc0"; e.currentTarget.style.color = "#a39a8a"; }}
                  >
          ...
          {/* Write a review */}
          <div style={{ maxWidth: "600px", padding: "2rem", background: "#ece6dc", border: "1px solid #d8cfc0" }}>
            <div className="label" style={{ marginBottom: "1.5rem" }}>Donner un avis</div>

            {reviewSubmitted ? (
              <p style={{ color: "#282828", fontSize: "13px", letterSpacing: "0.02em" }}>
              ...
              <form onSubmit={handleReviewSubmit} style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
                    ...
                    {[1, 2, 3, 4, 5].map((n) => (
                      ...
                      >
                        <Star
                          ...
                          style={{ color: n <= reviewRating ? "#f59e0b" : "#c9bfae", transition: "color 0.15s" }}
                        />
                      </button>
                    ))}
                  </div>
                ...
                <div>
                  <div className="label" style={{ fontSize: "10px", marginBottom: "0.625rem" }}>
                    Commentaire{" "}
                    <span style={{ color: "#c9bfae" }}>({reviewComment.length}/500)</span>
                  </div>
                  <textarea
                    value={reviewComment}
      ...
      {/* Related products */}
      {related.length > 0 && (
        <div style={{ padding: "4rem 0", borderTop: "1px solid #d8cfc0" }}>
          <div className="container-main">
            <div
              style={{
                display: "flex",
            ...
            >
              ...
              <Link
                href="/shop"
                style={{
                  fontSize: "11px", color: "#a39a8a", textDecoration: "none",
