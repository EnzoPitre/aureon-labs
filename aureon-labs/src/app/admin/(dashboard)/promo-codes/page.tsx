...
export default function AdminPromoCodesPage() {
  ...
  return (
    <div>
      ...
      >
        <div>
          <label style={{ display: "block", fontSize: "0.75rem", color: "#5c564e", marginBottom: "0.3rem" }}>
            Code
          </label>
          <input
            required
            ...
            placeholder="ETE2026"
            style={{ border: "1px solid #d8cfc0", borderRadius: "6px", padding: "0.5rem 0.625rem", fontSize: "0.85rem", width: "140px" }}
          />
        </div>
        <div>
          <label style={{ display: "block", fontSize: "0.75rem", color: "#5c564e", marginBottom: "0.3rem" }}>
          ...
          <select
            ...
            style={{ border: "1px solid #d8cfc0", borderRadius: "6px", padding: "0.5rem 0.625rem", fontSize: "0.85rem" }}
          >
        ...
        <div>
          ...
          <input
            ...
            style={{ border: "1px solid #d8cfc0", borderRadius: "6px", padding: "0.5rem 0.625rem", fontSize: "0.85rem", width: "90px" }}
          />
        </div>
        <div>
          <label style={{ display: "block", fontSize: "0.75rem", color: "#5c564e", marginBottom: "0.3rem" }}>
          ...
          <input
            ...
            style={{ border: "1px solid #d8cfc0", borderRadius: "6px", padding: "0.5rem 0.625rem", fontSize: "0.85rem", width: "110px" }}
          />
        </div>
        <div>
          <label style={{ display: "block", fontSize: "0.75rem", color: "#5c564e", marginBottom: "0.3rem" }}>
      ...
      {loading ? (
        ...
        <p style={{ color: "#5c564e" }}>Aucun code promo.</p>
      ) : (
        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "0.85rem" }}>
          ...
          <tbody>
            {codes.map((c) => (
              <tr key={c.id} style={{ borderBottom: "1px solid #e3dccd" }}>
                ...
                <td style={{ padding: "0.75rem 0.5rem" }}>
                  <button
                    ...
                    style={{
                      ...
                      fontWeight: 600,
                      cursor: "pointer",
                      background: c.is_active ? "rgba(16,185,129,0.1)" : "rgba(107,100,89,0.1)",
                      color: c.is_active ? "#10b981" : "#6b6459",
                    }}
                  >
